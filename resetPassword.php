...
$stmt = $pdo->prepare('SELECT resetToken, resetComplete FROM t_user WHERE resetToken = :token');
...
if(isset($_POST['submit'])){
	...
	if(!isset($error)){
		...
		try {
			...
			$stmt = $pdo->prepare("UPDATE t_user SET password = :hashedpassword, resetComplete = 'Yes'  WHERE resetToken = :token");
			$stmt->execute(array(
